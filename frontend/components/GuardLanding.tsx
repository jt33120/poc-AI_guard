      ...
      <section className="guard-masthead" aria-labelledby="home-heading">
        ...
        <div className="guard-wrap guard-masthead__inner">
          <div className="guard-masthead__copy">
            ...
            <div className="guard-masthead__actions"><a href="#usages" className="guard-button">{home.explore}<span aria-hidden="true">↓</span></a><Link href="/produits">{home.productsLink}<span aria-hidden="true">↗</span></Link></div>
