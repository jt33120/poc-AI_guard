...
export const GUARD_COPY = {
  fr: {
    ...
    paths: {
      company: {
        tag: "Entreprise",
        title: "Un déploiement piloté par votre organisation.",
        list: [
          "Distribuer les scripts via la gestion de vos postes (MDM)",
    ...
    saasProof:
      "Ce qui est bloqué, orchestré ou seulement attesté, ligne par ligne",
  ...
  en: {
    ...
    paths: {
      company: {
        tag: "Enterprise",
        title: "Deployment managed by your organisation.",
        list: [
          "Distribute scripts through device management (MDM)",
