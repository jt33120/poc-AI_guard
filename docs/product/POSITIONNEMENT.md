...
**Ce que le tableau dit sur nous.** Le chemin coopératif coûte **quatre fois** les
connexions du chemin obligatoire, parce qu'il ré-authentifie le jeton, relit la policy
et relit le droit de gamme à chaque requête là où MCP tient une session. C'est le prix
de la non-obligation, et il va dans le même sens que le §1 : l'étage MCP n'est pas
seulement le plus contraignant, il est aussi le moins cher.

**Ce que la quatrième connexion achète.** Le palier et les plafonds du tenant sont lus
à chaque appel et **jamais mis en cache**. C'est un choix, pas une négligence : un
droit servi de mémoire est un droit qu'on ne peut plus retirer, et la fenêtre pendant
laquelle il survivrait est exactement celle où un client rétrogradé a intérêt à
continuer. Le palier, les capacités, les plafonds, les quotas négociés et la
consommation du mois tiennent en **une seule** requête — trois lectures séparées
faisaient passer ce chemin de six à onze allers-retours, et c'est le gate de surcoût
qui l'a dit avant la revue.
